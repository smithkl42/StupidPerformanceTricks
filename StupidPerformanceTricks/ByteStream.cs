...
using System.Diagnostics;
    ...
    public class ByteStream
    {
        ...
        public ByteStream(int arraySize): this(new byte[arraySize])
        {
        }
        ...
        public short ReadInt16Raw()
        {
            return (short)((ByteArray[CurrentOffset++] << 8) | (ByteArray[CurrentOffset++] & 0xff));
        }
        ...
        public void WriteInt16Raw(short value)
        {
            byte[] bytes = BitConverter.GetBytes(value);
            ByteArray[CurrentOffset++] = bytes[0];
            ByteArray[CurrentOffset++] = bytes[1];
        }
        #endregion Int16
